...
if not exist "%~dp0python-3.11.9-embed-amd64\python.exe" (
    ...
    powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0downloaders\download_deps.ps1" -RequirementsFile "%~dp0script\requirements.txt" -PythonPath "%~dp0python-3.11.9-embed-amd64\python.exe" || goto :error
...
"%~dp0/python-3.11.9-embed-amd64/python.exe" "script\cli.py" %*
echo.
