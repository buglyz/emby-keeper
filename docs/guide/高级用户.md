...
高级用户权限请通过项目维护者提供的渠道开通.

目前有四种方式成为高级用户:

1. 通过维护者提供的购买渠道获得高级会员邀请码, 成为 SUPER 会员;
2. 分享邀请制 Emby 的邀请码, 可升级为 PRIME 会员, 较为珍惜的可以升级为 SUPER 会员;
3. 邀请新用户使用, 分享 2 个以升级为 PRIME 会员, 分享 5 个以升级为 SUPER 会员;
